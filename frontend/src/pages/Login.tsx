...
export function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(errorMessage.includes('401') ? 'Email atau password salah' : errorMessage);
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-base px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-content-primary">Masuk ke GovConnect</h1>
          <p className="text-content-tertiary mt-2 text-sm">Isi formulir layanan publik lebih cepat</p>
        </div>
